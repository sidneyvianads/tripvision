    ...
    <div className="px-4 pb-6">
      <div className="card p-4 mt-4">
        ...
        <div
          ...
          style={{ background: "rgba(124, 185, 232, 0.18)" }}
        >
          <div
      ...
      {CATS.map((cat) => {
        ...
        return (
          <section key={cat.id} className="mt-5">
            <div className="font-display font-extrabold text-base text-[#E8F0FE] px-1 mb-2">
              {cat.title}
            </div>
                  ...
                  >
                    ...
                    <div className="flex-1 min-w-0">
                      ...
                      {item.concluido && item.concluido_por && (
                        <div className="text-xs text-[#1A3A4A]/50 mt-0.5">
